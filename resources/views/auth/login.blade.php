                        ...
                        <div class="p-5 text-left rounded-lg">
                            ...
                            <form action="{{ route('login') }}" id="frmLogin" method="POST" class="pt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="email" type="text" class="rounded-lg form-control form-control-lg"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="password" type="password"
                                            class="rounded-lg form-control form-control-lg" name="password" required value="{{ isset($school) && $school->type == 'demo' ? $school->user->mobile : '' }}"
                                ...
                                @if ($school ?? '')
                                    <div class="form-group d-none">
                                        ...
                                        <input id="school_code" type="text" class="rounded-lg form-control form-control-lg"
                            ...
                            <div class="mt-3 row">
                                ...
                                <div class="mb-4 text-center col-12 text-black-50">Demo Credentials</div>
                            </div>
                            @if (empty($school) ?? '')
                                ...
                                <div class="mt-3 row">
                                    <div class="col-md-6">
                                        <button class="mt-2 btn w-100 btn-success" id="superadmin_btn">Super Admin</button>
                                    </div>

                                    <div class="col-md-6">
                                        <button class="mt-2 btn w-100 btn-info" id="superadmin_staff_btn">Staff</button>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="mt-3 row">
                                    <div class="col-md-4">
                                        <button class="mt-2 btn w-100 btn-info" id="schooladmin_btn">School Admin</button>
                                    </div>
                                    <div class="col-md-4">
                                        <button class="mt-2 btn w-100 btn-danger" id="teacher_btn">Teacher</button>
                                    </div>

                                    <div class="col-md-4">
                                        <button class="mt-2 btn w-100 btn-primary" id="schooladmin_staff_btn">Staff</button>
                                    </div>
                                </div>
