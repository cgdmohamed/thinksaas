                ...
                <div class="card">
                    <div class="card-body">
                        <form class="create-form-without-reset" action="{{ route('school-settings.store') }}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-2 border rounded-lg border-secondary">
                            ...
                            <div class="mx-1 my-4 border rounded-lg border-secondary">
                                <div class="mt-3 col-md-12"><h4>{{__("Domain Settings")}}</h4></div>
                            ...
                            <div class="mx-1 my-4 border rounded-lg border-secondary">
                                <div class="mt-3 col-md-12"><h4>{{__("Roll Number Settings")}}</h4></div>
                                <div class="mb-3 col-12">
                                    <hr class="mt-0">
                                </div>
...
{{--                            <div class="mb-3 border rounded-lg border-secondary">--}}
{{--                                <h3 class="mt-3 col-12 page-title ">--}}
...
{{--                            </div>--}}
                            ...
                            <input class="float-right ml-3 btn btn-theme" id="create-btn" type="submit" value={{ __('submit') }}>
